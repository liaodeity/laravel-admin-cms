...
<body class="hold-transition skin-blue-light sidebar-mini fixed position-relative @yield('body_class') ">
<!-- 主体 -->
@yield('content')
<!-- /主体 -->
...
<!--弹窗-->
<script src="{{asset ('admin-ui/lib/layer/layer.js')}}"></script>
...
<!-- /底部 -->
<a id="jump_blank_url" href="" class="hidden hide" target="_blank">跳转</a>
</body>
</html>
