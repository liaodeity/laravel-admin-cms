            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                            ...
                            <form class="form-inline list-search-form active" action="" onsubmit="return false;">
                                ...
                                <div class="input-group form-group">
                                    <div class="input-group-btn">
                                        <select name="timeType" class="form-control select2">
                                            <option value="reg" selected>注册时间</option>
                                            <option value="scan">扫码时间</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    {!! html_date_input ('count_date') !!}
                                </div>
                                <div class="form-group">
                        ...
                        <div class="box-body">
                            <button type="button"
                                    onclick="confirm_export_fun('导出','{{route('admin-reports.agent-bill','export=1')}}','确认导出当前查询条件数据？')"
