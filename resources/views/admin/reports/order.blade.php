            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-body">
                            <form class="form-inline list-search-form active" action="" onsubmit="return false;">
                                <div class="form-group">
                                    ...
                                    {!! html_date_input('order_at') !!}
                                </div>
                                <div class="form-group">
                                    <label for="">所属区域</label>
                                    <input id="region_id_value" type="hidden" name="region_id" value="">
                                    <input type="text" id="region_id_text" name="area_region_name" class="form-control cursor-pointer" onclick="report_region_select()" readonly >
                                </div>
                                <div class="form-group">
                        ...
                        <div class="box-body">
                            <button type="button"
                                    onclick="confirm_export_fun('导出','{{route('admin-reports.order','export=1')}}','确认导出当前查询条件数据？')"
