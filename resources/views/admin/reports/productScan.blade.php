                    ...
                    <div class="box">
                        <div class="box-body">
                            <form class="form-inline list-search-form active" action="" onsubmit="return false;">
                                ...
                                <div class="form-group">
                                    <label for="">扫码时间</label>
                                    {!! html_date_input('scan_at') !!}
                                </div>
                                <div class="form-group">
                        ...
                        <div class="box-body">
                            <button type="button"
                                    onclick="confirm_export_fun('导出','{{route('admin-reports.product-scan','export=1')}}','确认导出当前查询条件数据？')"
