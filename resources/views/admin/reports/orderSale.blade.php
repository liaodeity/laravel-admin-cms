            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                            ...
                            <form class="form-inline list-search-form active" action="" onsubmit="return false;">
                                <div class="form-group">
                                    ...
                                    <select name="countType" class="form-control select2">
                                        <option value="province_id" selected>省</option>
                                        <option value="city_id">市</option>
                                        <option value="county_id">县</option>
                                        <option value="town_id">区</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="">销售时间</label>
                                    {!! html_date_input('sale_at') !!}
                                </div>
                                <div class="form-group">
                        ...
                        <div class="box-body">
                            <button type="button"
                                    onclick="confirm_export_fun('导出','{{route('admin-reports.order-sale','export=1')}}','确认导出当前查询条件数据？')"
