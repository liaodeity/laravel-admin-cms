                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="proxy_region_id_text" class="form-control" name="OrderQrcode[region_name]" maxlength="50" id=""
                                           value="{{$order->qrcodes()->first()->region_name ?? ''}}"
                                           placeholder="">
...
{{--                                    </div>--}}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="" name="OrderQrcode[quality_inspector]" maxlength="20"
                                       value="{{$order->qrcodes()->first()->quality_inspector ?? ''}}"
                                       placeholder="可填写质检员">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control Wdate-bg" id="" name="OrderQrcode[production_date]" readonly
                                       value="{{$order->qrcodes()->first()->production_date ?? date('Y-m-d')}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <div class="input-group ">
                                    <input id="all_qrcode" type="text" class="form-control" value="{{$order->getQrCodeNumber() ?? 0}}"
                                           disabled>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input id="yes_qrcode" type="text" class="form-control"
                                       value="{{$order->qrcodeSuccessCount() ?? 0}}" disabled>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <input id="no_qrcode" type="text" class="form-control"
                                       value="{{$order->getQrCodeNumber() - $order->qrcodeSuccessCount() }}" disabled>
                            </div>
