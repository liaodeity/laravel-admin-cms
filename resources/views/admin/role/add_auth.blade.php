            ...
            <form class="layui-form" action="" lay-filter="example" onsubmit="return false;">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block ">
                        <input type="text" class="layui-input " name="Auth[title]" maxlength="50" autocomplete="off" value="{{$auth->title ?? ''}}" >
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block ">
                        <input id="name" type="text" class="layui-input " name="Auth[name]" maxlength="100" autocomplete="off" value="{{$auth->name ?? ''}}" >
                        <div class="layui-form-mid layui-word-aux ">（自动会转换成小写，请使用[英文或空格]标识，常规如“user|user show|user create|user edit|user delete|user import|user export”）</div>
                    </div>
                </div>
